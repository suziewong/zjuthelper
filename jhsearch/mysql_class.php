...
class mysql{
	 ...
	 */
	public function __construct($host='localhost',$usname='suzie',$passwd='027267',$dbname='bbs',$table='jhy_members',$charset='utf8'){
//	public function __construct($host='localhost',$usname='root',$passwd='',$dbname='test',$table='user',$charset='utf8'){
		$this->table = $table;
